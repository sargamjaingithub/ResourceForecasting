...
BASE_NAME = '1_set_experiments_google_type_3_hyperparameter_search_scinet'


PARAMETERS_TO_TEST = [
    {'keys': ['data', 'type', 'lag_size'], 'values': [32, 128, 512]},
    {'keys': ['model', 'network', 'args', 'hid_size'], 'values': [1, 2]},
    {'keys': ['model', 'network', 'args', 'dropout'], 'values': [0, 0.5]},
    {'keys': ['model', 'network', 'args', 'num_levels'], 'values': [1, 2]},
