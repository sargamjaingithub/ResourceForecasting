...
OUTPUT_PATH = '/home/ferran/Documents/bsc/time_series/paper/final_configs_paper/1_set_experiments/alibaba/type_3/scinet/hyperparameter_search/full_configs'
BASE_CONFIG = '/home/ferran/Documents/bsc/time_series/paper/final_configs_paper/1_set_experiments/alibaba/type_3/scinet/hyperparameter_search/base_config.json'
BASE_NAME = '1_set_experiments_type_3_hyperparameter_search_scinet'


PARAMETERS_TO_TEST = [
    {'keys': ['data', 'type', 'lag_size'], 'values': [32, 128, 512]},
    {'keys': ['model', 'network', 'args', 'hid_size'], 'values': [1, 2, 4]},
    {'keys': ['model', 'network', 'args', 'dropout'], 'values': [0, 0.5]},
    {'keys': ['model', 'network', 'args', 'num_levels'], 'values': [1, 2, 3]},
