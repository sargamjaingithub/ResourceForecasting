# This code is a slight modification of the original method, check https://github.com/BSC-IBM/ThetaScan for the original implementation

from app.models.classic_methods.types.theta_scan.theta_model import ThetaModel
from app.models.classic_methods.types.theta_scan.utilities import *


class ThetaScan():
    '''
    The ThetaScan class: Behavior-Driven Forecasting. This class contains all the classic_methods needed to analyze and forecast usage
